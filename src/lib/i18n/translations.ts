export const translations = {
  sr: {
    ...
    premiumCancelledAtPeriodEnd: "Премиум ће бити деактивиран на крају периода. Средства неће бити враћена.",
    failedToUpdatePremium: "Грешка при ажурирању премиум статуса",
    cancelPremium: "Откажи премиум",
    cancelPremiumTitle: "Отказивање премиума",
    cancelPremiumDescription: "Деактивацијом премиума у следећем месецу са вас неће бити наплаћен износ, премиум ће бити укинут следећег месеца. Током тренутног плаћеног периода можете вратити премиум без додатне наплате.",
    agree: "Сагласан сам",
  ...
  ru: {
    ...
    premiumCancelledAtPeriodEnd: "Премиум будет деактивирован в конце периода. Средства не будут возвращены.",
    failedToUpdatePremium: "Ошибка при обновлении премиум статуса",
    cancelPremium: "Отменить премиум",
    cancelPremiumTitle: "Отмена премиума",
    cancelPremiumDescription: "Деактивируя премиум в следующем месяце с вас не будет списана сумма, премиум будет снят со следующего месяца. В течение текущего оплаченного периода вы можете вернуть премиум без дополнительной оплаты.",
    agree: "Согласен",
  ...
  en: {
    ...
    premiumCancelledAtPeriodEnd: "Premium will be cancelled at the end of the period. Credits will not be refunded.",
    failedToUpdatePremium: "Failed to update premium status",
    cancelPremium: "Cancel premium",
    cancelPremiumTitle: "Cancel Premium",
    cancelPremiumDescription: "By deactivating premium next month you will not be charged, premium will be removed next month. During the current paid period you can restore premium without additional payment.",
    agree: "I agree",
